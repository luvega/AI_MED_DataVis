...
基础练习使用三类代码协作：解释已有短代码，生成用于核对字段或输出的最小片段，根据报错提出候选修改。分析脚本、清洗决策、统计方法和医学解释仍需学习者完成并核验。
...
从本章开始，每章证据包使用 `ai_log.md` 保存 AI 协作记录。这份记录应说明哪些 AI 建议被采纳或拒绝、代码是否实际运行，以及哪些问题仍未解决。
